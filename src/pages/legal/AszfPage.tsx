...
export default function AszfPage({ onNavigate }: { onNavigate: NavigateFn }) {
  return (
    <LegalPage title="Általános Szerződési Feltételek" onNavigate={onNavigate}>
      ...
      <p>Asztalt és privát rendezvényterületet a {SITE.email} e-mail-címen vagy a {SITE.phone} telefonszámon lehet előre egyeztetni. A Numina Caffè fenntartja a jogot a foglalás visszautasítására kapacitás és alkalmassági feltételek alapján.</p>
